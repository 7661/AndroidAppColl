...
public class CoTrackerDataModUIActivity extends Activity {

	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_tracker_mod_record_ui);
	...
	private boolean processRecord(){
		...
		EditText itemData = (EditText)findViewById(R.id.bankBalanceAmt);
		EditText amountData = (EditText)findViewById(R.id.amountData);
		...
		String dbModType = userSessionInfo.getDataModType();
		recordEntry.setUserId(userSessionInfo.getUserId());
		recordEntry.setDataTableName(userSessionInfo.getDataTableName());
		recordEntry.setDate(dateData.getText().toString());
		recordEntry.setAmount(amountData.getText().toString());
		recordEntry.setItem(itemData.getText().toString());
